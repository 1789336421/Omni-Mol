...
class LoraModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        # here, it updates the kwargs from config, hence passed to the layers
        # add learnable alpha option here
        kwargs = {
            "r": r,
            "lora_alpha": alpha,
            ...
            "use_learnable_alpha": getattr(lora_config, "use_learnable_alpha", False),
        ...
        # in case we already have lora layer
